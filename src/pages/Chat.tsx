...
export default function Chat() {
  ...
  const { recentChats, loading: recentChatsLoading, addRecentChat } = useRecentChats();
  ...
  const handleRecentChatSelect = async (recentChat: any) => {
    console.log('Selecting recent chat:', recentChat);
    
    // Create or get conversation
    const conversationId = await createConversation(recentChat.other_user_id);
    if (conversationId) {
      const tempChat = {
        conversation_id: conversationId,
        other_user_id: recentChat.other_user_id,
        other_user_name: recentChat.other_user_name,
        other_user_avatar: recentChat.other_user_avatar,
        other_user_university: recentChat.other_user_university,
        last_message: '',
      ...
      await addRecentChat(recentChat.other_user_id);
    }
  };
        ...
        {!selectedChat ? (
          ...
          <div className="flex flex-col h-screen bg-background">
            <MobileChatHeader 
              ...
              userUniversity={selectedChat.other_user_university}
              onBackClick={handleBackToList}
            />

            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-background mt-20 mb-20">
